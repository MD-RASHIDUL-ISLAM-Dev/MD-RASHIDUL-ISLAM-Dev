...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=F7B801&center=true&vCenter=true&width=600&lines=Self-taught+Developer+from+Bangladesh;Building+AI+Agents+%26+Automation+Tools;Python+%E2%86%92+LLM+APIs+%E2%86%92+Agent+Frameworks+%E2%86%92+MCP;Open+to+Freelance+Work+on+Fiverr+%26+Upwork" alt="Typing SVG" />
</p>
...
I'm a self-taught developer from **Narsingdi, Bangladesh**, currently focused on becoming a Full Stack AI Engineer. Instead of following the traditional university route, I chose to build real, working projects and pursue **international freelancing** through platforms like Fiverr and Upwork.

- 🔭 Currently building **RI PDF Vault Bot** — a feature-rich Telegram archive bot (Python + SQLite) with smart categorization, fuzzy search, access control, and automated backups
- 🌱 Learning path: **Python → LLM APIs → Agent Frameworks → Multi-Agent Systems / MCP → Freelancing**
- 💻 Core dev environment: Android (Termux) + Windows laptop — proof that you don't need expensive hardware to start
...
<p align="center">
  ...
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=MD-RASHIDUL-ISLAM-Dev&theme=tokyonight&hide_border=true" width="48%" />
</p>
